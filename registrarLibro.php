        ...
        <div class="header">
            <form action="funcionregistrar.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="libroNombre" placeholder="" maxlength="30" required>
                </div>
                <div class="mb-3">
                    <label for="Autor" class="form-label">Autor del Libro</label>
                    <input type="text" class="form-control" name="libroAutor" placeholder="" maxlength="30">
                </div>
                <div class="mb-3">
                    <label for="Lanzamiento" class="form-label">Fecha de Lanzamiento</label>
                    <input type="text" class="form-control" name="libroLanzamiento" placeholder="" required maxlength="30">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="libroEditorial" placeholder="" maxlength="10" min="0">
                </div>
                <div class="footer">
                    <div class="col-auto">
